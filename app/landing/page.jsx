...
export default function LightSaaSLandingPage() {
  ...
  const faqs = [
    ...
    { q: "What is the difference between the ₹999, ₹1,999 and ₹3,999 plans?", a: "The Starter plan (₹999) includes 3 social accounts with no AI support. The Growth plan (₹1,999) includes 6 accounts with full AI support and 500 credits. The Pro plan (₹3,999) gives you Unlimited accounts, Unlimited AI credits, and multi-workspace features." },
    ...
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans antialiased">
      ...
      <section className="py-20 px-6 max-w-5xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-xs text-slate-500 mt-1">Full side-by-side feature comparison of Starter (₹999), Growth (₹1,999) and Pro (₹3,999).</p>
        </div>
            ...
            <table className="w-full text-left border-collapse text-xs">
              <thead>
                <tr className="bg-slate-50 text-slate-600 font-bold border-b border-slate-200/80">
                  ...
                  <th className="p-4 text-center">Starter (₹999/mo)</th>
                  <th className="p-4 text-center bg-indigo-50/50 text-indigo-950 font-extrabold">Growth (₹1,999/mo) ★</th>
                  <th className="p-4 text-center">Pro Unlimited (₹3,999/mo)</th>
                </tr>
              </thead>
