    ...
    <div className="space-y-8 font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-200/80">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-violet-600 text-white font-bold text-xs shadow-md shadow-violet-600/20 hover:bg-violet-700 transition-all transform active:scale-95"
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {SUPPORTED_PLATFORMS.map((platform) => {
                    ...
                    >
                      ...
                      <div className="bg-slate-50 rounded-xl p-3 border border-slate-100 flex items-center justify-between text-xs">
                        <div>
                          ...
                          <span className="font-extrabold text-slate-900">{platform.followersDefault}</span>
                        </div>
                        <div className="text-right">
                          <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">Last Synced</span>
                          <span className="text-slate-600 font-medium">2 mins ago</span>
                        </div>
                      </div>
            ...
            return (
              <div 
                key={platform.id} 
                className="bg-white rounded-2xl border border-dashed border-slate-200 p-6 shadow-sm hover:border-violet-300 hover:bg-slate-50/50 transition-all flex flex-col items-center text-center justify-between space-y-4"
              >
                ...
                <div>
                  <h4 className="text-base font-bold text-slate-900">{platform.name}</h4>
                ...
                <button
                  onClick={() => setIsModalOpen(true)}
                  className="w-full py-2.5 px-4 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 font-bold text-xs shadow-xs transition-all hover:border-violet-300 hover:text-violet-600"
                >
                  Connect Account
                </button>
              </div>
