        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-left">
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 space-y-2">
            ...
            <ul className="text-[11px] text-slate-600 space-y-1 font-medium">
              ...
              <li className="flex items-center gap-1.5"><Check className="w-3 h-3 text-rose-600 font-bold" /> 🛡️ 20 AI Copyright Scans</li>
          ...
          <div className="rounded-2xl border-2 border-indigo-600 bg-indigo-50/50 p-4 space-y-2 relative shadow-xs">
            ...
            <ul className="text-[11px] text-slate-700 space-y-1 font-medium">
              ...
              <li className="flex items-center gap-1.5"><Check className="w-3 h-3 text-rose-600 font-bold" /> 🛡️ 200 AI Copyright Scans</li>
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 space-y-2">
            ...
            <div className="text-lg font-black text-slate-950">₹7,999<span className="text-[10px] text-slate-500 font-normal">/mo</span></div>
            <ul className="text-[11px] text-slate-600 space-y-1 font-medium">
              <li className="flex items-center gap-1.5"><Check className="w-3 h-3 text-emerald-600" /> Unlimited Channels</li>
              <li className="flex items-center gap-1.5"><Check className="w-3 h-3 text-rose-600 font-bold" /> 🛡️ UNLIMITED AI Scans</li>
