...
export async function postToTwitter({ accessToken, videoBuffer, text, isVideo, mimeType, disableComments }) {
  ...
  // Create tweet with media + optional reply restrictions
  const tweetBody = { text, media: { media_ids: [mediaId] } };
  if (disableComments) {
