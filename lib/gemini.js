...
Return ONLY JSON:
{
  ...
  const result = {
    ...
    layers: {
      ...
      layer2: {
        ...
        details: layer2Executed 
          ? "Deep semantic caption, brand safety, and risk classification analyzed via Gemini AI."
    ...
    aiModelUsed: layer2Executed ? "Google Gemini AI Copilot" : "Layer 1 Local Risk Engine (API Cost Saved)",
